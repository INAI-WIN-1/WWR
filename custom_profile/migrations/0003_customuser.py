...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('custom_profile', '0002_alter_game_created_at'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(3000000), django.core.validators.MinValueValidator(0)])),
